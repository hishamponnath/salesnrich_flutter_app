class AccountProfileModel {
  ...
  dynamic trimChar;
  bool? hasDefaultAccountInventory;
  bool? promptStockLocationInventory;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['hasDefaultAccountInventory'] = hasDefaultAccountInventory;
    data['promptStockLocationInventory'] = promptStockLocationInventory;
    ...
    data['isImportStatus'] = isImportStatus;
